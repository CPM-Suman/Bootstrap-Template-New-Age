...
class Customizer_Repeater extends WP_Customize_Control {
	...
	public $customizer_repeater_text5_control = false; //suman
			...
			foreach($array as $icon){ ?>
                <div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
                    ...
                    <div class="customizer-repeater-box-content-hidden">
						<?php
						$choice = $image_url = $icon_value = $title = $subtitle = $text = $text2 = $text5 = $link2 = $link = $shortcode = $repeater = $color = $color2 = '';
						if(!empty($icon->id)){
							$id = $icon->id;
						}
...
if($this->customizer_repeater_text5_control==true){
	$this->input_control(array(
		'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text5','your-textdomain' ), $this->id, 'customizer_repeater_text5_control' ),
...
//
            ...
            <div class="customizer-repeater-general-control-repeater-container">
                ...
                <div class="customizer-repeater-box-content-hidden">
					<?php // image and icon sayad yaha chha 
					if ( $this->customizer_repeater_image_control == true && $this->customizer_repeater_icon_control == true ) {
...
if ( $this->customizer_repeater_text5_control == true ) {
	$this->input_control( array(
		'label' => apply_filters('repeater_input_labels_filter', esc_html__( 'Text5','your-textdomain' ), $this->id, 'customizer_repeater_text5_control' ),
		'class' => 'customizer-repeater-text5-control',
		'type'  => apply_filters('customizer_repeater_input_types_filter', 'textarea', $this->id, 'customizer_repeater_text5_control' ),
	) );
}
//
